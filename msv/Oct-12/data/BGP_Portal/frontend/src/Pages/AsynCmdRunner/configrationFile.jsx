...
const Index = ({
  ...
  // let [dataSourceConfig, setDataSourceConfig] = useState(excelData);
  ...
  //       setDataSourceConfig(excelData);
  //       setRowCountConfig(excelData.length);
