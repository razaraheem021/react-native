...
const index = () => {
  ...
  const [value1, value2, value3, value4] =
    Object.keys(queryParams)[0].split("-,-");
    ...
    <MainDivwithoutSidebar>
      <Spin spinning={loading}>
        ...
        >
          ...
          <Button style={{ background: "rgb(0, 155, 219)" }} onClick={Apply}>
            Apply <EnterOutlined />
          </Button>
        </div>
        <TableStyle
