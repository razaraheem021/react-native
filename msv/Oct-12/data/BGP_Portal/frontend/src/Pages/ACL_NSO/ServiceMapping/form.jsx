  ...
  useEffect(() => {
    (async () => {
      if (selectedDevice[siteTabSelected] !== undefined) {
        ...
        //
        //
        const responseVrf = await axios.post(baseUrl + "/aclApiVrfList", {
          device_name: device,
        });
        ...
        const vrfDataConcat = vrf_data.concat({ name: "empty-vrf", value: "" });
        //
        //
        setVrf((prevState) => ({
          ...prevState,
          [device]: vrfDataConcat,
        }));
      }
    })();
  }, [selectedDevice]);
