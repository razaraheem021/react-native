...
const Sidebar = ({ collapsed, onCollapse }) => {
  ...
  return (
    ...
    collapsed={collapsed} onCollapse={onCollapse}>
      ...
      <SidebarMenuItem key="/dashboard/main" icon={<UserOutlined />}
      //  className="custom-menu-item"
      >
          <NavLink to="/dashboard/main">Home</NavLink>
        </SidebarMenuItem>
        <SidebarMenuItem key="/dashboard/message" icon={<VideoCameraOutlined />}
        //  className="custom-menu-item"
        >
          <NavLink to="/dashboard/message">Messsage</NavLink>
        </SidebarMenuItem>
