  ...
  return (
    <>
      <SidebarSection collapsed={collapsed} onCollapse={onCollapse}>
        ...
        >
          <SidebarMenuItem
            key="/async-cmd-runner/main"
            icon={<CompassOutlined />}
            mainloc={
              pathname === "/async-cmd-runner/main" ||
              pathname === "/async-cmd-runner/detail" ||
              pathname === "/async-cmd-runner/cmd"
            }
            //  className="custom-menu-item"
          >
            <NavLink to="/async-cmd-runner/main">Router</NavLink>
          </SidebarMenuItem>
          {/* <SidebarMenuItem
            key="/async-cmd-runner/cmd"
            icon={<CompassOutlined />}
            //  className="custom-menu-item"
          >
            <NavLink to="/async-cmd-runner/cmd">Command Runner</NavLink>
          </SidebarMenuItem>
          <SidebarMenuItem
